<x-layout>
    ...
    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Pengaduan Dayasos</h1>
                    <p class="mb-4">
                                        ...
                                        @foreach($pengaduan as $item)
                                            <tr>
                                                ...
                                                <form action="{{ route('pengaduan.destroy', $item->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" name="halaman" value="dayasos"> {{-- ubah sesuai halaman: ppkg / rehsos / linjamsos / dayasos --}}
